...
class ValueAddedServiceController extends Controller
{
    ...
    {
        $data = ValueAddedService::select('harga_service.*')
    ...
    {
        $data = ValueAddedService::leftJoin('dermaga as d', 'harga_service.id_dermaga_tujuan', 'd.id')
    ...
    public function store(Request $request)
    {
        ...
        ValueAddedService::create($validator->validated());
    ...
    public function delete(Request $request)
    {
        ...
        ValueAddedService::where('id', $request->id)->delete();
    ...
    public function massUpdate(Request $request)
    {
        ...
        return response()->json(ValueAddedService::whereIn('id', $arrId)->get(), 201);
    }
    ...
    public function massDelete(Request $request)
    {
        ...
        ValueAddedService::whereIn('id', $arrId)->delete();
